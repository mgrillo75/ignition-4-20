...
#
# Ignition 8.3 Gateway Tag Change Script (project scope).
# Bound to [default]GCS_RTAC_Control/ActiveRTAC on value change.
#
# Event locals: tagPath, previousValue, currentValue, initialChange, missedEvents.
